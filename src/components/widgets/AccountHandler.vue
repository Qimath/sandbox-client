...
import { login, signup, logout, loginWithGoogle, loginWithGithub } from '../../hooks/identity.js'
...
async function userLogin() {
  ...
  try {
    const result = await login(userCredentials.email.value, userCredentials.password.value)
...
async function userSignup() {
  ...
  try {
    const result = await signup(userCredentials.email.value, userCredentials.password.value)
