...
var B = { memory: () => new V().enclosedCache, localstorage: () => new W() };
var Q = (e) => B[e];
var q = (e) => {
...
var ee = class {
  constructor(e) {
    let t, i;
    if (this.userCache = new V().enclosedCache, this.defaultOptions = { authorizationParams: { scope: "openid profile email" }, useRefreshTokensFallback: false, useFormData: true }, this._releaseLockOnPageHide = async () => {
...
var ae = { isLoading: ref(false), isAuthenticated: ref(false), user: ref(void 0), idTokenClaims: ref(void 0), error: ref(null), loginWithPopup: ne, loginWithRedirect: ne, getAccessTokenSilently: ne, getAccessTokenWithPopup: ne, logout: ne, checkSession: ne, handleRedirectCallback: ne };
var se = ref(ae);
var re = class {
  constructor(e, o) {
    var n, a2;
  ...
  install(e) {
    this._client = new ee(Object.assign(Object.assign({}, this.clientOptions), { auth0Client: { name: "auth0-vue", version: "2.2.1" } })), this.__checkSession(e.config.globalProperties.$router), e.config.globalProperties.$auth0 = this, e.provide(a, this), se.value = this;
  }
  async loginWithRedirect(e) {
...
function le(e) {
  ...
  return async (e2) => ce(t ? t.config.globalProperties.$auth0 : unref(se), e2, i);
}
async function de(e) {
  return ce(unref(se), e);
}
function ue(e, t) {
  return oe(e), new re(e, t);
}
function he() {
  return inject(a);
}
export {
  ...
  re as Auth0Plugin,
  V as InMemoryCache,
  W as LocalStorageCache,
  te as User,
  de as authGuard,
  ue as createAuth0,
  le as createAuthGuard,
  he as useAuth0
};
