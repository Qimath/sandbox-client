...
var CrispMessage = (
  ...
  function() {
    ...
    CrispMessage2.prototype.setMessageText = function(content) {
    ...
    CrispMessage2.prototype.startThread = function(name) {
      this.parent.createSingletonIfNecessary();
      window.$crisp.push(["do", "message:thread:start", [name]]);
    };
    CrispMessage2.prototype.endThread = function(name) {
      this.parent.createSingletonIfNecessary();
    ...
    CrispMessage2.prototype.offMessageSent = function() {
      this.parent.createSingletonIfNecessary();
    ...
    CrispMessage2.prototype.offMessageReceived = function() {
      this.parent.createSingletonIfNecessary();
    ...
    CrispMessage2.prototype.offMessageComposeSent = function() {
      this.parent.createSingletonIfNecessary();
      window.$crisp.push(["off", "message:compose:sent"]);
    };
    CrispMessage2.prototype.onMessageComposeReceived = function(callback) {
      this.parent.createSingletonIfNecessary();
      this.offMessageComposeReceived();
      window.$crisp.push(["on", "message:compose:received", callback]);
    };
    CrispMessage2.prototype.offMessageComposeReceived = function() {
      this.parent.createSingletonIfNecessary();
...
var CrispUser = (
  ...
  function() {
    ...
    CrispUser2.prototype.offEmailChanged = function() {
      if (this.parent.isCrispInjected()) {
    ...
    CrispUser2.prototype.offPhoneChanged = function() {
      if (this.parent.isCrispInjected()) {
    ...
    CrispUser2.prototype.offNicknameChanged = function() {
      if (this.parent.isCrispInjected()) {
    ...
    CrispUser2.prototype.offAvatarChanged = function() {
      if (this.parent.isCrispInjected()) {
...
var CrispSession = (
  ...
  function() {
    ...
    CrispSession2.prototype.offLoaded = function() {
      this.parent.createSingletonIfNecessary();
...
var CrispChat = (
  ...
  function() {
    ...
    CrispChat2.prototype.setHelpdeskView = function() {
      this.parent.createSingletonIfNecessary();
      window.$crisp.push(["do", "helpdesk:search"]);
    };
    CrispChat2.prototype.openHelpdeskArticle = function(locale, slug, title, category) {
      this.parent.createSingletonIfNecessary();
    ...
    CrispChat2.prototype.queryHelpdesk = function(query) {
      this.parent.createSingletonIfNecessary();
    ...
    CrispChat2.prototype.offChatInitiated = function() {
      this.parent.createSingletonIfNecessary();
    ...
    CrispChat2.prototype.offChatOpened = function() {
      this.parent.createSingletonIfNecessary();
    ...
    CrispChat2.prototype.offChatClosed = function() {
      this.parent.createSingletonIfNecessary();
      window.$crisp.push(["off", "chat:closed"]);
    };
    CrispChat2.prototype.onHelpdeskQueried = function(callback) {
      this.parent.createSingletonIfNecessary();
      this.offHelpdeskQueried();
      window.$crisp.push(["on", "helpdesk:queried", callback]);
    };
    CrispChat2.prototype.offHelpdeskQueried = function() {
      this.parent.createSingletonIfNecessary();
...
var Crisp = (
  ...
  function() {
    ...
    Crisp2.prototype.onWebsiteAvailabilityChanged = function(callback) {
      this.createSingletonIfNecessary();
      this.offWebsiteAvailabilityChanged();
      window.$crisp.push(["on", "website:availability:changed", callback]);
    };
    Crisp2.prototype.offWebsiteAvailabilityChanged = function() {
      this.createSingletonIfNecessary();
    ...
    Crisp2.prototype.autoInjectIfNecessary = function() {
