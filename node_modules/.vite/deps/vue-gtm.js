...
// node_modules/vue-gtm/dist/config.js
var require_config = __commonJS({
  "node_modules/vue-gtm/dist/config.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
// node_modules/vue-gtm/dist/utils.js
var require_utils = __commonJS({
  "node_modules/vue-gtm/dist/utils.js"(exports) {
    "use strict";
    ...
    function loadScript(id, config) {
      ...
      var queryString = new URLSearchParams(__assign({ id }, (_c = config.queryParams) !== null && _c !== void 0 ? _c : {}));
...
// node_modules/vue-gtm/dist/plugin.js
var require_plugin = __commonJS({
  "node_modules/vue-gtm/dist/plugin.js"(exports) {
    "use strict";
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
    ...
    var VueGtmPlugin = (
      /** @class */
      function() {
        function VueGtmPlugin2(id, options) {
          if (options === void 0) {
            options = config_1.DEFAULT_CONFIG;
          }
          this.id = id;
          this.options = options;
          this.isInBrowserContext = function() {
            return typeof window !== "undefined";
          };
        }
        VueGtmPlugin2.prototype.enabled = function() {
          var _a;
          return (_a = this.options.enabled) !== null && _a !== void 0 ? _a : true;
        };
        VueGtmPlugin2.prototype.enable = function(enabled) {
          var _this = this;
          if (enabled === void 0) {
            enabled = true;
          }
        ...
        VueGtmPlugin2.prototype.debugEnabled = function() {
          var _a;
          return (_a = this.options.debug) !== null && _a !== void 0 ? _a : false;
        };
        VueGtmPlugin2.prototype.debug = function(enable) {
          this.options.debug = enable;
        };
        VueGtmPlugin2.prototype.dataLayer = function() {
          var _a;
        ...
        VueGtmPlugin2.prototype.trackView = function(screenName, path, additionalEventData) {
          var _a;
          if (additionalEventData === void 0) {
            additionalEventData = {};
          }
        ...
        VueGtmPlugin2.prototype.trackEvent = function(_a) {
          var _b;
          if (_a === void 0) {
            _a = {};
          }
          ...
          if (this.options.debug) {
            console.log("[VueGtm]: Dispatching event", __assign({
              event,
              category,
              action,
              label,
          ...
          if (this.isInBrowserContext() && this.options.enabled) {
            ...
            dataLayer.push(__assign({ event: event !== null && event !== void 0 ? event : "interaction", target: category, action, "target-properties": label, value, "interaction-type": noninteraction }, rest));
          }
        };
        return VueGtmPlugin2;
      }()
    );
...
// node_modules/vue-gtm/dist/index.js
var require_dist = __commonJS({
  "node_modules/vue-gtm/dist/index.js"(exports) {
    var __assign = exports && exports.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
          s = arguments[i];
      ...
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_b) {
          switch (_b.label) {
            ...
            case 3:
              ignoredViews = ignoredViews.map(function(view) {
              ...
              vueRouter.afterEach(function(to, from, failure) {
                ...
                var additionalEventData = (_b2 = (_a2 = to.meta) === null || _a2 === void 0 ? void 0 : _a2.gtmAdditionalEventData) !== null && _b2 !== void 0 ? _b2 : {};
...
vue-router/dist/vue-router.cjs:
  (*!
    * vue-router v4.1.6
    ...
    *)
*/
//# sourceMappingURL=vue-gtm.js.map
